...
import content from "@/data/insurance-comparator-fr";
...
export default function DeveloppementComparateurAssurance() {
  return (
    <div>
      <PageSeo
        title={content.title}
