          ...
          <div className="row pt-130 pb-100">
            ...
            <div className="col-xxl-4 col-xl-5 col-lg-6 col-md-6">
              <div className="blog__text">
                <p>
                  Explore our portfolio of successful projects. From website creation and digital campaigns to brand identities — see the impact we&apos;ve delivered for our clients.
                </p>
              </div>
            </div>
          </div>
                        ...
                        <div className="pp-slide-img">
                          <Link href="/portfolio-details">
                            <Image
                              ...
                              style={{ height: "auto" }}
                              src={Portfolio11}
                              alt="Nova Impact Portfolio Project"
                            />
                          </Link>
                        </div>
                      </div>
              ...
              >
                <SwiperSlide>
                  <div className="pp-slide-thumb">
                    <h3 className="pp-slide-title">Website Redesign</h3>
                    <p>2024</p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="pp-slide-thumb">
                    <h3 className="pp-slide-title">Digital Campaign</h3>
                    <p>2024</p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="pp-slide-thumb">
                    <h3 className="pp-slide-title">Brand Identity</h3>
                    <p>2025</p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="pp-slide-thumb">
                    <h3 className="pp-slide-title">SEO Optimization</h3>
                    <p>2025</p>
                  </div>
                </SwiperSlide>
              </Swiper>
...
export default PortfolioElementV6;
