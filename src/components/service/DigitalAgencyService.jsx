...
const Service11 = "/images/service-content-creation.webp";
const Service12 = "/images/service-social-media.webp";
const Service13 = "/images/service-meta-ads.webp";
const Service14 = "/images/service-google-ads.webp";
          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="service__top-text text-anim">
                <p>
                  From strategy to execution, Nova Impact delivers digital solutions tailored to your business goals.
                </p>
              </div>
            </div>
            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
              <div className="service__top-btn">
                <div className="btn_wrapper">
                  <Link href="/service" className="btn-item wc-btn-secondary btn-hover">
                    <span></span> View <br />
            ...
            <div className="row">
              ...
              <div className="col-xxl-8 col-xl-8 col-lg-12 col-md-12">
                <div className="service__list" ref={serviceList}>
                  ...
                  <Link href="/service" className={activeList == 1 ? "active" : ""} data-service="1">
                    <div className="service__item animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">Website Creation</h4>
                      </div>
                      <div className="service__text">
                        <p>Modern, fast, and conversion-focused websites designed to represent your brand and drive results.</p>
                      </div>
                      <div className="service__link"><p><i className="fa-solid fa-arrow-right"></i></p></div>
                    </div>
                  </Link>

                  <Link href="/service" className={activeList == 2 ? "active" : ""} data-service="2">
                    <div className="service__item animation_home1_service">
                      <div className="service__number"><span>02</span></div>
                      <div className="service__title-wrapper">
                        <h4 className="service__title">Social Media Management</h4>
                      </div>
                      <div className="service__text">
                        <p>We build and manage your presence across platforms to engage your audience and grow your brand.</p>
                      </div>
                      <div className="service__link"><p><i className="fa-solid fa-arrow-right"></i></p></div>
                    </div>
                  </Link>

                  <Link href="/service" className={activeList == 3 ? "active" : ""} data-service="3">
                    <div className="service__item animation_home1_service">
                      <div className="service__number"><span>03</span></div>
                      <div className="service__title-wrapper">
                        <h4 className="service__title">Meta Ads (Facebook & Instagram)</h4>
                      </div>
                      <div className="service__text">
                        <p>Targeted ad campaigns designed to maximize ROI and bring qualified traffic.</p>
                      </div>
                      <div className="service__link"><p><i className="fa-solid fa-arrow-right"></i></p></div>
                    </div>
                  </Link>

                  <Link href="/service" className={activeList == 4 ? "active" : ""} data-service="4">
                    <div className="service__item animation_home1_service">
                      <div className="service__number"><span>04</span></div>
                      <div className="service__title-wrapper">
                        <h4 className="service__title">Comparator Creation (Personalized)</h4>
                      </div>
                      <div className="service__text">
                        <p>We build custom comparison platforms tailored to your niche to drive traffic, leads, and monetization.</p>
                      </div>
                      <div className="service__link"><p><i className="fa-solid fa-arrow-right"></i></p></div>
                    </div>
                  </Link>
